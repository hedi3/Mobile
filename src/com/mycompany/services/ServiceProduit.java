...
public class ServiceProduit {
    ...
    public void ajouterProduit(Product product) {
        ...
        String url = Statics.BASE_URL + "/AddProdJSON/new?name=" + product.getName() + "&image=" + product.getImage() + "&subtitle=" + product.getSubtitle() + "&prix=" + product.getPrix() + "&description=" + product.getDescription();
    ...
    public boolean modifierProduct(Product product) {
        ...
        String url = Statics.BASE_URL + "/updateProdJSON/" + product.getId() + "?name=" + product.getName() + "&image=" + product.getImage() + "&subtitle=" + product.getSubtitle() + "&prix=" + product.getPrix() + "&description=" + product.getDescription();
        req.setUrl(url);

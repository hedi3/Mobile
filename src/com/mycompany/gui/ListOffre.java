...
searchField = new TextField("", "Chercher un offre");
...
getContentPane().animateLayout(250);
          ...
          ArrayList<Offre>liste=ServiceOffre.getInstance().affichageOffre();
        for(Offre art : liste)
        {
            addButton(art);
        }
    ...
    private void addButton(Offre a) {
     
        
        Label ta1 = new Label("Duree :" + a.getDuree(),"NewsTopLine");
        Label ta2 = new Label("Solde :" + a.getSolde(),"NewsTopLine");
...
Button bt=new Button("Modifier!");
          bt.addActionListener(s->new ModifierOffre(theme,a).show());
        createLineSeparator();
     Button btns=new Button("supprimer");
          ...
          if(dig.show("Suppression","Voulez-vous supprimer cette offre? ","Annuler","Oui")){
              ...
              if(ServiceOffre.getInstance().deleteOffre(a.getId())){

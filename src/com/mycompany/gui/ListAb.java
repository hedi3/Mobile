 ...
 * @author FK Info
 */
public class ListAb extends Form {
Form current;
 Resources theme;
...
getContentPane().animateLayout(250);
          ...
          ArrayList<Abonnement>liste=ServiceAbonnement.getInstance().affichageAb();
        for(Abonnement art : liste)
        {
            addButton(art);
        }
    ...
    private void addButton(Abonnement a) {
     
        
        Label ta1 = new Label("Name :" + a.getName(),"NewsTopLine");
        Label ta2 = new Label("Email :" + a.getEmail(),"NewsTopLine");
        Label ta3 = new Label("Numtel :" + a.getNumtel(),"NewsTopLine");
...
Button bt=new Button("Modifier!");
          bt.addActionListener(s->new ModifierAbonnement(theme,a).show());
        createLineSeparator();
     Button btns=new Button("supprimer");
          ...
          if(dig.show("Suppression","Voulez-vous supprimer cette reclamation? ","Annuler","Oui")){
              ...
              if(ServiceAbonnement.getInstance().deleteAb(a.getId())){

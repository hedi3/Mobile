 ...
 * @author FK Info
 */
public class ListMateriel extends Form {
Form current;
 Resources theme;
public Component createLineSeparator() {
   ...
   public ListMateriel(Form previous) {
       theme = UIManager.initFirstTheme("/theme");
        setTitle("Liste des réclamations");
            //search tbadel 3onwen tool bar
//prepare field
TextField searchField;
searchField = new TextField("", "Chercher un abonnement");
...
getContentPane().animateLayout(250);
          ...
          ArrayList<Materiel>liste=ServiceMateriel.getInstance().affichageM();
        for(Materiel art : liste)
        {
            addButton(art);
        }
    ...
    private void addButton(Materiel a) {
     
        
        Label ta1 = new Label("Ref :" + a.getRef(),"NewsTopLine");
        Label ta2 = new Label("Categorie :" + a.getCategorie(),"NewsTopLine");
        Label ta3 = new Label("Description :" + a.getDescription(),"NewsTopLine");
...
Button bt=new Button("Modifier!");
          bt.addActionListener(s->new ModifierMateriel(theme,a).show());
        createLineSeparator();
     Button btns=new Button("supprimer");
          ...
          if(dig.show("Suppression","Voulez-vous supprimer cette reclamation? ","Annuler","Oui")){
              ...
              if(ServiceMateriel.getInstance().deleteMa(a.getId())){

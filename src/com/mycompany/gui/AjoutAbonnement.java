 ...
 * @author MY HP
 */
public class AjoutAbonnement extends BaseForm {

    Form current;

    public AjoutAbonnement(Resources res) {
        ...
        RadioButton liste = RadioButton.createToggle("Liste Abonnement", barGroup);
        liste.setUIID("SelectBar");
        
        liste.addActionListener(l-> { 
           
          Dialog dig= new Dialog("ListeAbonnement");
        ...
        RadioButton partage = RadioButton.createToggle("Ajouter Abonnement", barGroup);
        partage.setUIID("SelectBar");
        
        partage.addActionListener(l-> { 
           
          Dialog dig= new Dialog("Ajouter Abonnement");
         
          new AjoutAbonnement(res).show();
       ...
       // bindButtonSelection(mesListes, arrow);
        ...
        TextField email = new TextField("", "entrer le email!");
        email.setUIID("TextFieldBlack");
        addStringValue("Subtitle", email);

        TextField numtel = new TextField("", "entrer le numero!");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                if (name.getText() == "" || email.getText() == "" || numtel.getText() == "") {
                    ...
                    Abonnement p = new Abonnement(String.valueOf(name.getText()
                    ).toString(),
                    ...
                    ServiceAbonnement.getInstance().ajouterAbonnement(p);
                    ...
                    String accountSID = "AC7af9cfb82122d9232a9d3c902e0a9d18";
String authToken = "b95d94ae2017c4f0479738927380bf52";
String fromPhone = "+18645286980";
String destinationPhone="+21650505512";
        setTitle("List article");
      Response<Map> result = Rest.post("https://api.twilio.com/2010-04-01/Accounts/" + accountSID + "/Messages.json").
        queryParam("To", destinationPhone).
        queryParam("From", fromPhone).
        queryParam("Body", "abonnement ajouté").

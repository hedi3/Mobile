 ...
 * @author MY HP
 */
public class AjoutMateriel extends BaseForm {

    Form current;

    public AjoutMateriel(Resources res) {
        ...
        RadioButton liste = RadioButton.createToggle("Liste Materiel", barGroup);
        liste.setUIID("SelectBar");
        
        liste.addActionListener(l-> { 
           
          Dialog dig= new Dialog("ListeMateriel");
        ...
        partage.addActionListener(l-> { 
          ...
          Dialog dig= new Dialog("Ajouter Materiel");
       ...
       // bindButtonSelection(mesListes, arrow);
        ...
        TextField categorie = new TextField("", "entrer la categorie!");
        ...
        btnAjouter.addActionListener((e) -> {
            ...
            try {
                if (ref.getText() == "" || categorie.getText() == "" || description.getText() == "") {
                    ...
                    Materiel p = new Materiel(String.valueOf(ref.getText()
                    ).toString(),
                    ...
                    ServiceMateriel.getInstance().ajouterMateriel(p);
